			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Mathai<span>Noshto</span></a>
                    <h5 class="text-muted fw-normal mb-4">Amar to MathaNoshto, ashen apnar tao kori.</h5>
